...
const ToursDetails = () => {
  ...
  //fetch Data from database
   ...
   //destructure ptoperties for tour object
        ...
        <div className="tour__content">
          ...
          <div className="tour__info">
            ...
            <span className='tour__rating d-flex align-items-center gap-1'>
                <i className="ri-star-fill" style={{'color':'orange'}}></i> {avgRating ===0 ? null :avgRating} 
                {totalRating ===0 ? (
                    "Not Rated"
                    ):(
            ...
            <div className="tour__extra-details">
              <span>
              <i className="ri-map-pin-2-user-line"></i>{city}
              </span>
              <span>
